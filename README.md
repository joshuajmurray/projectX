...
This is an interactive art exhibit using a Microsoft Kinect V1 (model 1414) and various Processing libraries. The Kinect V2 can be used as well with some software changes. Refer to Shiffman Kinect Resourse link for more info on using a Kinect V2.
...
* [Install OpenKinect](https://github.com/shiffman/OpenKinect-for-Processing/releases) - Kinect Library
		...
		Unzip the OpenKinect library to /processing-3.3.7/lib/
